...
const TEACHER_ID = '9f07b8b3-753e-49c5-83b0-ff6ac58907fc';
...
export default function () {
    ...
    // Query aggregated stats from evaluator
    const statsRes = http.get(`http://localhost:8080/reports/evaluators/${TEACHER_ID}`);
    check(statsRes, { 'aggregated stats status is 200 or 404': (r) => r.status === 200 || r.status === 404 });
